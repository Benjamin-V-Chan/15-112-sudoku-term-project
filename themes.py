...
blueTheme = Theme(bgColor=gradient('dodgerBlue', 'darkBlue'), buttonColor='dodgerBlue', buttonBorderColor='black', textColor='black', hoverBorderColor='lightblue', clickColor='navy', gridColor='black', cellColor='dodgerBlue', activeColor='skyblue', correctGuessColor='lightGreen', wrongGuessColor='tomato', singleGuessColor='yellow', tupleColor='orange', titleColor='black')
