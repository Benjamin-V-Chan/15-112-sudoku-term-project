...
redTheme = Theme(bgColor=gradient('crimson','red','darkRed'), buttonColor='red', buttonBorderColor='black', textColor='black', hoverBorderColor=gradient('yellow', 'orange', 'orangeRed'), clickColor='darkRed', gridColor='black', cellColor='red', activeColor='pink', correctGuessColor='lightGreen', wrongGuessColor='orange', singleGuessColor='yellow', tupleColor='orange', titleColor='black')
